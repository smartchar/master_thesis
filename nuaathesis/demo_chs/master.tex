...
\begin{figure}[h!]  
	\subfloat[PID控制下控制电流时域波形\label{fig:5-s3-i-w1-pid}]{\includegraphics[scale=1.0]{5-s3-i-w1-pid.png}}\quad  
	\subfloat[PID+陷波器控制下控制电流时域波形\label{fig:5-s3-i-w1-pid-nf}]{\includegraphics[scale=1.0]{5-s3-i-w1-pid-nf.png}}  
...
\begin{figure}[h!]  
	\subfloat[PID控制下控制电流时域波形\label{fig:5-s3-i-w1-pid_1}]{\includegraphics[scale=1.0]{5-s3-i-w1-pid.png}}\quad  
	\subfloat[PID+重复控制器控制下控制电流时域波形\label{fig:5-s3-i-w1-pid-orc}]{\includegraphics[scale=1.0]{5-s3-i-w1-pid-nf.png}}  
