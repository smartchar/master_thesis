...
\begin{figure}[h!]
  \subfloat[Mecos公司二氧化碳鼓风机]{\includegraphics[height=4cm]{1-Mecos.png}}\quad
  \subfloat[Calnetix公司余热回收发电系统]{\includegraphics[height=4cm]{1-Calnetix.png}}\quad
  \subfloat[SKF公司污水处理厂通用鼓风机系统]{\includegraphics[height=4cm]{1-Skf.png}}\quad  
...
\begin{figure}[h!]
  \subfloat[飞旋科技磁悬浮复合分子泵]{\includegraphics[height=6cm]{1-Feixuan.jpg}}\quad
  \subfloat[磁谷科技磁悬浮离心式鼓风机]{\includegraphics[height=6cm]{1-Cigu.png}}\quad
...
\begin{figure}[h!]  
	\subfloat[XA控制通道输出敏感度函数曲线\label{fig:5-sens_x}]{\includegraphics[scale=1.0]{5-sens_x.png}}\quad  
	\subfloat[YA控制通道输出敏感度函数曲线\label{fig:5-sens_y}]{\includegraphics[scale=1.0]{5-sens_y.png}}\quad  	
	\subfloat[XB控制通道输出敏感度函数曲线\label{fig:5-sens_u}]{\includegraphics[scale=1.0]{5-sens_u.png}}\quad  
	\subfloat[YB控制通道输出敏感度函数曲线\label{fig:5-sens_v}]{\includegraphics[scale=1.0]{5-sens_v.png}}\quad  			
...
\begin{figure}[h!]  
	\subfloat[现场动平衡前PID控制下控制电流时域波形\label{fig:5-s3-i-w1-pid}]{\includegraphics[scale=1.0]{5-s3-i-w1-pid.png}}\quad  
	\subfloat[现场动平衡前PID+陷波器控制下控制电流时域波形\label{fig:5-s3-i-w1-pid-nf}]{\includegraphics[scale=1.0]{5-s3-i-w1-pid-nf.png}}  
...
\begin{figure}[h!]  
	...
	\subfloat[现场动平衡前加入陷波器前后B端转子轴心轨迹\label{fig:5-s3-x_locus-w1-pid-nf_aend}]{\includegraphics[scale=1.0]{5-s3-x_locus-w1-pid-nf_aend.png}}  
...
\begin{figure}[h!]  
	\subfloat[现场动平衡前PID控制下控制电流时域波形\label{fig:5-s3-i-w1-pid_1}]{\includegraphics[scale=1.0]{5-s3-i-w1-pid.png}}\quad  
	\subfloat[现场动平衡前PID+重复控制器控制下控制电流时域波形\label{fig:5-s3-i-w1-pid-orc}]{\includegraphics[scale=1.0]{5-s3-i-w1-pid-nf.png}}  
